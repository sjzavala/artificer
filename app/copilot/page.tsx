...
export const metadata = { title: 'Artificer — Copilot' };

export default function CopilotPage() {
  return (
    <AppShell active="copilot" salesforceMode={salesforceMode()}>
      ...
      <main className="mx-auto flex h-[calc(100vh-3.5rem)] w-full max-w-4xl flex-col px-5 py-8 sm:h-[calc(100vh-4rem)] sm:px-8">
        <header className="mb-5 shrink-0">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-ink-soft">
            Ask across your deals, their documents and the buyer pipeline at once — including who
